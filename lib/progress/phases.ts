...
export const PROJECT_PHASES: readonly ProjectPhase[] = [
  ...
  },
  {
    ...
    evidence: [
      ...
      'Verification: npm test 340 passing, typecheck and build clean; 0025_campaign_management.sql applied to the local Supabase database and lifecycle/lineage triggers verified at the SQL level. Pending: manual end-to-end verification of the deployed campaign workflow before this phase can close.',
    ],
  },
  {
    phase: 12,
